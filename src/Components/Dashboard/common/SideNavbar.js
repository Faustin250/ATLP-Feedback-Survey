            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/"
                >
                  <i className="far fa-question-circle text-gray-500 mr-2 text-sm"></i> Q/A Management
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/"
                >
                  <i className="fas fa-signal text-gray-500 mr-2 text-sm"></i> Statistics
                </Link>
              </li>
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/"
                >
                  <i className="fas fa-lightbulb text-gray-500 mr-2 text-sm"></i> Insights
                </Link>
              </li>
